export default function BaseResp({ Icon, Text }) {
    return (
        <div className=" min-w-64 max-w-80 min-h-64 max-h-80 shadow-[0_5px_5px_-6px] bg-Black-False rounded-xl flex justify-center items-center pl-2.5 pr-2.5 pb-2.5 pt-2.5">
