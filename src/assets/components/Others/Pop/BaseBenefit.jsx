export default function BaseBenefit({ Icon, Text }) {
    return (
        <div className=" min-w-72 max-w-80 h-80 shadow-[0_5px_5px_-6px] bg-gradient-to-b from-Sunset-Blaze to-Golden-Ember rounded-xl flex justify-center items-center pl-2.5 pr-2.5 pb-2.5 pt-2.5">
