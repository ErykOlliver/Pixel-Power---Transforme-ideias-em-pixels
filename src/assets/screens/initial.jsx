        ...
        <section id="bgInitial" className='flex justify-center h-screen w-screen items-center gap-2.5 relative'>
            ...
            <div className='flex justify-center items-center relative w-screen h-screen'>
                ...
                <div className=' flex flex-col w-xl gap-8'>
                    ...
                    <button className='hover:cursor-pointer w-full h-20 border-4 border-black font-bold shadow-[0_8px] shadow-black rounded-xl text-3xl bg-gradient-to-l from-[#F96C00] to-[#F99C39] text-white'>Quero saber mais</button>
                </div>
            </div>
        </section>
    )
